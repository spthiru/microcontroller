...
z	equ	0
pclath	equ	10
# 2 "G:\PIC ass\7SEGMENT\7seg0tof.c"
...
;; *************** function _main *****************
;; Defined at:
;;		line 5 in file "G:\PIC ass\7SEGMENT\7seg0tof.c"
...
;;
psect	maintext
	file	"G:\PIC ass\7SEGMENT\7seg0tof.c"
	line	5
...
l1831:	
;7seg0tof.c: 12: PORTD=0b11111001;
	movlw	(0F9h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1835:	
;7seg0tof.c: 15: PORTD=0b10100100;
	movlw	(0A4h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1839:	
;7seg0tof.c: 18: PORTD=0b10110000;
	movlw	(0B0h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1843:	
;7seg0tof.c: 21: PORTD=0b10011001;
	movlw	(099h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1847:	
;7seg0tof.c: 24: PORTD=0b10010010;
	movlw	(092h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1851:	
;7seg0tof.c: 27: PORTD=0b10000010;
	movlw	(082h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1855:	
;7seg0tof.c: 30: PORTD=0b11111000;
	movlw	(0F8h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1859:	
;7seg0tof.c: 33: PORTD=0b10000000;
	movlw	(080h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1863:	
;7seg0tof.c: 36: PORTD=0b10010000;
	movlw	(090h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1867:	
;7seg0tof.c: 39: PORTD=0b10001000;
	movlw	(088h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1871:	
;7seg0tof.c: 42: PORTD=0b10000000;
	movlw	(080h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1875:	
;7seg0tof.c: 45: PORTD=0b11000110;
	movlw	(0C6h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1879:	
;7seg0tof.c: 48: PORTD=0b11000000;
	movlw	(0C0h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1883:	
;7seg0tof.c: 51: PORTD=0b10000110;
	movlw	(086h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l1887:	
;7seg0tof.c: 54: PORTD=0b10001110;
	movlw	(08Eh)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
